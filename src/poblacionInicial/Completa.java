...
public class Completa extends InicializacionArbol{

	@Override
	public ArbolOperaciones inicializacionAleatoria(int max) {
		Random r = new Random();
		ArrayList<Operacion> operandos = OperacionesSeleccionadas.getOperacionesSeleccionadas().getOperacionesBinariosSeleccionados();
		operandos.addAll(OperacionesSeleccionadas.getOperacionesSeleccionadas().getOperacionesUnariasSeleccionadas());
